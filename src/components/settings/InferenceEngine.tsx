...
const InferenceEngineSection: React.FC<InferenceEngineProps> = ({
  ...
  const engines = [
    ...
    },
    {
      ...
      name: 'MLC LLM',
      description: 'Machine Learning Compilation for LLMs (yet to be implemented)',
      icon: 'flash',
      enabled: false,
    },
    {
      ...
      name: 'MNN',
      description: 'Mobile Neural Network inference framework (yet to be implemented)',
      icon: 'cellphone',
      enabled: false,
    },
    {
      ...
      name: 'MLX',
      description: 'Apple Silicon optimized inference (yet to be implemented)',
      icon: 'apple',
      enabled: false,
