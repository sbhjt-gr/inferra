...
with_node \
  ...
  --target "/Users/subhajitgorai/Desktop/ragionare-llm-runner/ios/Pods/Target Support Files/Pods-Ragionare/ExpoModulesProvider.swift" \
  --entitlement "/Users/subhajitgorai/Desktop/ragionare-llm-runner/ios/Ragionare/Ragionare.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-background-fetch" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-document-picker" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
